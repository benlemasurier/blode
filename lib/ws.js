/* Hacked version of http://github.com/ncr/node.ws.js
 *
 * Compatible with node v0.1.91
 * Original Author: Jacek Becela
 *     Contributors:
 ...
 *       Andreas Kompanez
 * License: MIT
 * Originaly based on: http://github.com/Guille/node.websocket.js
*/
...
exports.createServer = function(websocketListener, options) {
  ...
  return net.createServer(function (socket) {
    ...
    websocketListener(emitter); // emits: "connect", "data", "end", provides: write(data), end()
  });
}
